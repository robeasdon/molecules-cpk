...
var UI = (function($, Viewer) {
    ...
    var rcsbURL = 'http://www.rcsb.org/pdb/explore/explore.do?structureId=';
    ...
    var updateFileInfo = function(protein) {
        $fileInfo.html(
            '<a href=\"' + rcsbURL + protein.pdbID + '\" target="_blank">' + protein.pdbID + '</a>' +
            '<br>' +
            protein.title
        );
    };
    ...
    var download = function() {
        ...
        Viewer.download(pdbId).done(function() {
            updateFileInfo(Viewer.getProtein());
        }).always(hideLoading);
    };
