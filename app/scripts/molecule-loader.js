...
var MoleculeLoader = (function($) {
    ...
    var VDWList = {
        AG: 1.72, AR: 1.85, AS: 1.85, AU: 1.66, BR: 1.85,
        C: 1.70, CD: 1.58, CL: 1.75, CU: 1.40, F: 1.47,
        FE: 1.47, GA: 1.87, H: 1.20, HE: 1.40, HG: 1.55,
        I: 1.98, IN: 1.93, K: 2.75, KR: 2.02, LI: 1.82,
        MG: 1.73, N: 1.55, NA: 2.27, NE: 1.54, NI: 1.63,
        O: 1.52, P: 1.80, PB: 2.02, PD: 1.63, PT: 1.72,
        S: 1.80, SE: 1.90, SI: 2.10, SN: 2.17, TE: 2.06,
        TL: 1.96, U: 1.86, XE: 2.16, ZN: 1.39
    };
    ...
    var download = function(pdbID) {
        ...
        var url = 'http://www.rcsb.org/pdb/files/' + protein.pdbID + '.pdb';
